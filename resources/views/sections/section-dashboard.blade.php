<!-- Search bar -->
<div class="relative w-full max-w-xs mb-5">
    <!-- Icon Search -->
...
<!-- Curva S -->
<div class="max-w-4xl mx-auto bg-white  dark:bg-gray-200 p-6 rounded-lg shadow-lg mb-4">
...
<div class="grid grid-cols-2 gap-2 mb-4">
    ...
    <div class="max-w-4xl mx-auto bg-white rounded-lg shadow-sm dark:bg-gray-800 p-4 md:p-6">
