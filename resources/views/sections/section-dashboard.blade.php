<div class="bg-blue-50">
    <!-- Curva S -->
    <div class="max-w-3xl mx-auto bg-white  dark:bg-gray-200 p-6 rounded-lg shadow-lg mb-4">
        <h1 class="text-2xl font-semibold mb-6 text-center">Kurva S (S-Curve) Project Progress</h1>
        <canvas id="sCurveChart" height="200"></canvas>
    </div>
    <div class="grid grid-cols-3 gap-3 mb-4">
        <!-- Bar Charts Horizontal -->
        <div class=" mx-auto bg-white rounded-lg shadow-sm p-4 md:p-6">
            ...
            <div class="grid grid-cols-1 items-center border-gray-200 border-t justify-between">
                <div class="flex justify-between items-center pt-5">
                    <!-- Button -->
                    <button id="dropdownButton" data-dropdown-toggle="lastDaysdropdown1"
                ...
                <div class="flex justify-between items-center pt-5">
                    ...
                    <div id="lastDaysdropdown2"
                        ...
                        <ul class="py-2 text-sm text-gray-700" aria-labelledby="dropdownDefaultButton">
                            ...
                            <li><a href="#" class="block px-4 py-2 hover:bg-gray-100">Last 30 days</a></li>
                            <li><a href="#" class="block px-4 py-2 hover:bg-gray-100">Last 90 days</a></li>
                            <li><a href="#" class="block px-4 py-2 hover:bg-gray-100">Last 6 months</a></li>
        ...
        <!-- Area Charts -->
        <div class="max-w-xl mx-auto bg-white rounded-lg shadow-sm p-4 md:p-6">
            <div class="flex justify-between mb-5">
                    ...
                    <div>
                        <h5 class="inline-flex items-center text-gray-500 leading-none font-normal mb-2">
                            ...
                            <svg data-popover-target="clicks-info" data-popover-placement="bottom"
                                class="w-3 h-3 text-gray-400 hover:text-gray-900 cursor-pointer ms-1"
                ...
                <div>
                    <button id="dropdownButtonArea" data-dropdown-toggle="lastDaysdropdownArea"
                ...
                <div class="pt-5">
                    <a href="#"
                        ...
                        <svg class="w-3.5 h-3.5 text-white me-2 rtl:rotate-180" aria-hidden="true"
                            ...
                            <path d="M14.066 0H7v5a2 2 0 0 1-2 2H0v11a1.97 1.97 0 0 0 1.934 2h12.
        <svg class="w-3.5 h-3.5 text-white me-2 rtl:rotate-180" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 20">
          <path d=" M14.066 0H7v5a2 2 0 0 1-2 2H0v11a1.97 1.97 0 0 0 1.934 2h12.132A1.97 1.97 0 0 0 16 18V2a1.97 1.97 0
                                0 0-1.934-2Zm-3 15H4.828a1 1 0 0 1 0-2h6.238a1 1 0 0 1 0 2Zm0-4H4.828a1 1 0 0 1
                                0-2h6.238a1 1 0 1 1 0 2Z" />
    ...
    <div class="grid grid-cols-3 gap-3 mb-4">
        <!-- Bar Charts Vertical -->
        <div class="col-span-2 max-w-3xl mx-3xl bg-white rounded-lg shadow-sm p-4 md:p-6">
            <div class="flex justify-between border-gray-200 border-b pb-3">
                <dl>
                    <dt class="text-base font-normal text-gray-500 pb-1">Profit</dt>
                    <dd class="leading-none text-3xl font-bold text-gray-900">Rp.5,405</dd>
                </dl>
                <div>
                    <span
                        class="bg-green-100 text-green-800 text-xs font-medium inline-flex items-center px-2.5 py-1 rounded-md">
            ...
            <div class="grid grid-cols-2 py-3">
                <dl>
                    <dt class="text-base font-normal text-gray-500 pb-1">Income</dt>
                    <dd class="leading-none text-xl font-bold text-green-500">Rp.23,635</dd>
                </dl>
                <dl>
                    <dt class="text-base font-normal text-gray-500 pb-1">Expense</dt>
                    <dd class="leading-none text-xl font-bold text-red-600">Rp.-18,230</dd>
                </dl>
            </div>
