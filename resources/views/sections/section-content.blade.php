<div class="flex justify-between items-center mb-4">
    ...
    <div class="flex items-center gap-2">
        <!-- Button Sinkron Data -->
        <button type="button"
            class="inline-flex items-center px-2 py-1 bg-yellow-500 hover:bg-yellow-600 text-white text-xs font-medium rounded-md shadow focus:outline-none focus:ring-1 focus:ring-orange-400">
        ...
        <table class="w-full table-auto text-sm text-left text-gray-500">
            ...
            <tbody>
                <tr class="border-b hover:bg-gray-50">
                    ...
                    <td class="px-2 py-3 whitespace-nowrap">P001</td>
                    <td class="px-2 py-3 whitepasce-nowrap">KAI Terrace Ahmad Palembang</td>
                    <td class="px-2 py-3">Palembang</td>
                    <td class="px-2 py-3">PPC</td>
                    <td class="px-2 py-3">Damandaru Harumandoyo</td>
                    <td class="px-2 py-3">Rp 1.000.000.000</td>
                    ...
                    <td class="px-2 py-3 flex justify-center gap-2">
                        <button class="p-2 bg-green-500 hover:bg-green-600 text-white rounded" title="Edit">
                            Edit
                        </button>
                        <button class="p-2 bg-blue-500 hover:bg-blue-600 text-white rounded" title="Delete">
                            Details
                        </button>
                    </td>
                </tr>
