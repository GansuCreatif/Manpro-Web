<div class="flex justify-between items-center mb-4">
    ...
    <div class="flex items-center gap-2">
        <!-- Button Sinkron Data -->
        <button type="button"
            class="inline-flex items-center px-2 py-1 bg-orange-500 hover:bg-yellow-600 text-white text-xs font-medium rounded-md shadow focus:outline-none focus:ring-1 focus:ring-orange-400">
            ...
            <tbody id="projectTable">
                @forelse ($projects as $index => $project)
                    <tr
                        ...
                        <td class="px-2 py-3 whitespace-nowrap">{{ $project['project_def'] }}</td>
                        <td class="px-2 py-3">{{ $project['project_desc'] }}</td>
                        <td class="px-2 py-3">{{ $project['project_location'] }}</td>
                        <td class="px-2 py-3">{{ $project['project_profile']['unit_desc'] ?? '-' }}</td>
                        <td class="px-2 py-3">{{ $project['project_responsible']['name'] ?? '-' }}</td>
