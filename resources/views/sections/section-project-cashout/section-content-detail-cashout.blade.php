...
<script>
    ...
    const projectData = [{
        ...
        type: "PR",
        doc: "xxxxxxxxxx",
        datesubmit: "15 January 2025",
        value: "Rp.200.000.000",
        daterealese: "15 January 2025",
        status: "Close"
    }];
        ...
        paginatedData.forEach(project => {
            ...
            const row = `
                    <tr>
                        ...
                        <td class="text-center">${project.umd}</td>
                        <td class="text-center">${project.type}</td>
                        <td class="text-center whitespace-nowrap">${project.doc}</td>
                        <td class="text-center">${project.datesubmit}</td>
                        <td class="px-2 py-2 text-center whitespace-nowrap">${project.value}</td>
                        <td class="text-center whitespace-nowrap">${project.daterealese}</td>
