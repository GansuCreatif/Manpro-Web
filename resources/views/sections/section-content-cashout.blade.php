            ...
            <table id="cashinTable" class="min-w-full table-200 text-xs text-left text-black">
                <thead class="text-xs text-blue-900 uppercase bg-blue-50 text-center">
                    <tr class="border-b-[3px] border-blue-700">
                        ...
                        <th class="px-2 py-3">UMD</th>
                        <th class="px-2 py-3">Type</th>
                        <th class="px-2 py-3">Doc. No</th>
                        <th class="px-2 py-3">Date Submit</th>
                        <th class="px-2 py-3">Value</th>
                        <th class="px-2 py-3">Date Realease</th>
                ...
                <tbody>
                    <tr class="bg-white">
                        ...
                        <td class="text-center">BAS BORONG 1</td>
                        <td class="text-center">PR</td>
                        <td class="text-center">xxxxxxxx</td>
                        <td class="text-center">15 January 2025</td>
                        <td class="text-center">Rp.200.000.000</td>
                        <td class="text-center">15 January 2025</td>
                        <td class="text-center text-blue-500 font-bold">Close</td>
                    ...
                    <tr class="bg-blue-50">
                        ...
                        <td class="text-center">UMD 1</td>
                        <td class="text-center">NPD</td>
                        <td class="text-center">xxxxxxxx</td>
                        <td class="text-center">30 January 2025</td>
                        <td class="text-center">Rp.50.000.000</td>
                        <td class="text-center">30 January 2025</td>
                        <td class="text-center text-red-500 font-bold">SP-1</td>
                        <td class="py-2 flex justify-center gap-2">
                            <a href="#" class="p-2 bg-blue-500 hover:bg-blue-600 text-white rounded">
                                Details
                            </a>
                    ...
                    <tr class="bg-white">
                        ...
                        <td class="text-center">UMD 2</td>
                        <td class="text-center">NPD</td>
                        <td class="text-center">xxxxxxxx</td>
                        <td class="text-center">2 February 2025</td>
                        <td class="text-center">Rp.20.000.000</td>
                        <td class="text-center">2 February 2025</td>
                        <td class="text-center text-green-500 font-bold">Realease</td>
                        <td class="py-2 flex justify-center gap-2">
                            <a href="#" class="p-2 bg-blue-500 hover:bg-blue-600 text-white rounded">
                                Details
                            </a>
                    ...
                    <tr class="bg-blue-50">
                        ...
                        <td class="text-center">UMD 3</td>
                        <td class="text-center">NPD</td>
                        <td class="text-center">xxxxxxxx</td>
                        <td class="text-center">28 February 2025</td>
                        <td class="text-center">Rp.15.000.000</td>
                        <td class="text-center">28 February 2025</td>
                        <td class="text-center text-blue-300 font-bold">Verify</td>
                        <td class="py-2 flex justify-center gap-2">
                            <a href="#" class="p-2 bg-blue-500 hover:bg-blue-600 text-white rounded">
                                Details
                            </a>
                    ...
                    <tr class="bg-white">
                        ...
                        <td class="text-center">UMD 4</td>
                        <td class="text-center">NPD</td>
                        <td class="text-center">xxxxxxxx</td>
                        <td class="text-center">23 April 2025</td>
                        <td class="text-center">Rp.17.500.000</td>
                    ...
                    <tr class="bg-blue-50">
                        ...
                        <td class="text-center">UMD 5</td>
                        <td class="text-center">NPD</td>
                        <td class="text-center">xxxxxxxx</td>
                        <td class="text-center">23 April 2025</td>
                        <td class="text-center">Rp.35.000.000</td>
                        <td class="text-center">23 April 2025</td>
                        <td class="text-center text-orange-300 font-bold">Approval 2</td>
                        <td class="py-2 flex justify-center gap-2">
                            <a href="#" class="p-2 bg-blue-500 hover:bg-blue-600 text-white rounded">
                                Details
                            </a>
                    ...
                    <tr class="bg-white">
                        ...
                        <td class="text-center">BAS BORONG 2</td>
                        <td class="text-center">PR</td>
                        <td class="text-center">xxxxxxxx</td>
                        <td class="text-center">4 May 2025</td>
                        <td class="text-center">Rp.220.000.000</td>
                        <td class="text-center">4 May 2025</td>
                        <td class="text-center  text-orange-300 font-bold">Approval 1</td>
                        <td class="py-2 flex justify-center gap-2">
                            <a href="#" class="p-2 bg-blue-500 hover:bg-blue-600 text-white rounded">
                                Details
                            </a>
                    ...
                    <tr class="bg-blue-50">
                        <td class="text-center">7</td>
                        <td class="text-center">BAS BORONG 3</td>
                        <td class="text-center">PR</td>
                        <td class="text-center">xxxxxxxx</td>
                        <td class="text-center">15 May 2025</td>
                        <td class="text-center">Rp.120.000.000</td>
                        <td class="text-center">4 May 2025</td>
                        <td class="text-center text-blue-900 font-bold">Request</td>
                        <td class="py-2 flex justify-center gap-2">
                            <a href="#" class="p-2 bg-blue-500 hover:bg-blue-600 text-white rounded">
                                Details
                            </a>
